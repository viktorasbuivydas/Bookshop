    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header dark d-flex justify-content-between align-items-center"><a href="{{route('admin.authors.index')}}" class="btn btn-primary">Back</a> Edit Author</div>
                @if(session('success'))
