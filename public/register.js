          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.sendRegisterRequest(_this.details).then(function () {
...
var render = function() {
  ...
  return _vm.error && _vm.error.length > 0
    ? _c(
        "div",
        { staticClass: "alert alert-danger my-2", attrs: { role: "alert" } },
        [_vm._v("\n    " + _vm._s(_vm.error[0]) + "\n")]
      )
    : _vm._e()
}
          ...
          _c("form", [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("Error", { attrs: { error: _vm.$store.state.errors.name } })
              ],
              1
            ),
            _vm._v(" "),
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("Error", { attrs: { error: _vm.$store.state.errors.email } })
              ],
              1
            ),
            _vm._v(" "),
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.details.date_of_birth,
                      expression: "details.date_of_birth"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { type: "date", id: "date" },
                  domProps: { value: _vm.details.date_of_birth },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
